...
function modify_submit(categorytemplateCount){
	var flag = false;
	for(i=0; i<categorytemplateCount; i++){
		obj = document.getElementById('checkcategorytemplate_id'+i);
		if(obj.checked){
			flag = true;
			break;
		}
	...
	if(!flag){
		...
		document.frm2.action="edit9_edit.php";
		document.frm2.submit();
	}
}
function delete_submit(categorytemplateCount){
	var flag = false;
	for(i=0; i<categorytemplateCount; i++){
		obj = document.getElementById('checkcategorytemplate_id'+i);
		if(obj.checked){
