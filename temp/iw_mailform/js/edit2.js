...
function modify_submit(templateCount){
	var flag = false;
	for(i=0; i<templateCount; i++){
		obj = document.getElementById('checktemplate_id'+i);
		if(obj.checked){
			flag = true;
			break;
		}
	...
	if(!flag){
		...
		document.frm2.action="edit2_edit.php";
		document.frm2.submit();
	}
}
function delete_submit(templateCount){
	var flag = false;
	for(i=0; i<templateCount; i++){
		obj = document.getElementById('checktemplate_id'+i);
		if(obj.checked){
